...
error_reporting(0);
$server    = "localhost";
$username  = "u1605741_bigbook";
$password  = "bigbook123";

mysql_connect($server, $username, $password) or die("<span style='float: right; margin-top:195px;border-radius: 10px;padding: 2em;
...
<body>
  ...
  if ($step == "2") {
    ...
    if (mysql_select_db("u1605741_bigbook")) {
  ...
  `logo` varchar(100) collate latin1_general_ci NOT NULL
      ...
      mysql_query("CREATE DATABASE `u1605741_bigbook` DEFAULT CHARACTER SET latin1 COLLATE latin1_general_ci;") or die(mysql_error());
      mysql_select_db("u1605741_bigbook");
      mysql_query("CREATE TABLE `barang` (
  `kode` varchar(10) NOT NULL,
  `nama` varchar(30) NOT NULL,
  `satuan` varchar(6) NOT NULL,
  ...
  <?php
    ...
    mysql_select_db('u1605741_bigbook') or die(mysql_error("error 3"));
...
('01', '$bulan','$thn_sekarang');") or die(mysql_error());
 ...
 VALUES ($thn, $kemarin, 0, 0, 0, 0, 0, 0, 0);") or die(mysql_error());
      ...
      <h2>Tahap 3 : INSTALL MODUL</h1>
        <div class="tengah">
          ...
          <div id="status">
            ...
            echo "<p align=\"center\">";
            //this is the connection file for the database....
            mysql_select_db('u1605741_bigbook') or die(mysql_error("error menampilkan modul"));
              ...
              <fieldset>
                ...
                <table>
                  <tr>
                    ...
                    <td> <input type="text" name='nama_perusahaan' size=30></td>
                  </tr>
                  <tr>
                    <td>E-mail</td>
                  ...
                  <tr>
                    <td>Alamat</td>
                    <td> <textarea name='alamat' width='70' height='50'></textarea></td>
                  </tr>
                  <tr>
                    <td>No.Telp/HP</td>
  ...
  <?php } elseif ($step == "5") {
    ...
    mysql_select_db('u1605741_bigbook') or die(mysql_error());
        ...
        <div class="tengah">
          <div id="finis">
            <fieldset>
              <table border="0">
                <msg>
                  <p><b><img src="../img/icon/bestseller.ico">Bigbook</b>Acoungting</p>
                </msg>
    ...
    <div class="main">
      <h2>Tahap 1 : Selamat Datang di Menu Install Aplikasi BigbookAcoungting Versi 1.15.0</h1>
        <div class="tengah">
          ...
          <p style="text-align:justify"><textarea>
