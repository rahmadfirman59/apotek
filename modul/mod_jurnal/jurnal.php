							...
							<table class="table table-hover">
								...
								?>
									<tr class="body">
										...
										<td>
											<div align="center"><?php echo $row_tran['kode_transaksi']; ?></div>
										</td>
										<td>
								...
								<tr class="footer">
									<td colspan="4">
										<div align="center"><strong>TOTAL TRANSAKSI</strong></div>
									</td>
		...
		<div class="row">
			<div class="col-md-6">
				...
				<div class="panel panel-default">
					...
					<td><div align=\"right\">Rp.&nbsp" . number_format($r[jumlah], 2, '.', ',');
										echo "</div></td>
				</tr>";
									}
									?>
								...
								<tr class="footer">
									<td colspan="3">
										<div align="center"><strong>TOTAL Penyesuaian</strong></div>
									</td>
						...
						<div class="panel-body">
							<div class="panel-group" id="accordion">
										...
										<div class="panel-body">
                                            ...
                                            <td>";
														...
														<tr class="footer">
															...
															<td colspan="6">
																<div align="right"><strong>Retur</strong></div>
															</td>
															<td><strong>
																	<?php
																	if ($cret > 0) {
																		$grand = $sql[total] - $ret[total];
																		echo "Rp&nbsp" . number_format($ret[total], 2, ',', '.');
																		echo "</h4>";
																	} else {
																		echo "Rp&nbsp" . number_format($ret[total], 2, ',', '.');
																		echo "</h4>";
								...
								<!-- <div class="panel panel-default">
									<div class="panel-heading">
										<?php echo "
											<p style='font-size:12pt;>* faktur pembelian<br><i class='icon-user'></i>Petugas :$sql[user] |<i class='icon-user'></i>Petugas Retur :$ret[user] |";
										if ($cret > 0) {
