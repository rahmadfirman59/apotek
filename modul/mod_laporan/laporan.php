					...
					<div class="panel-body">
						<div class="table-responsive">
							<table class="table table-hover">
								...
								<tr class="body">
									<td colspan='7'>
										<div align="left">Persedian Awal</div>
									</td>
								...
								<tr class="body">
									<td colspan='5'>
										<div align="left">Potongan Pembelian</div>
									</td>
								...
								<tr class="body">
									<td colspan='5'>
										<div align="left">Retur Pembelian</div>
									</td>
									<td align="right"><?php echo "Rp." . number_format($ret[jumlah], 2, '.', ','); ?>+
										<hr>
									</td>
									<td align="right"><?php  ?></td>
								</tr>
								<tr class="body">
									...
									<td align="right"><?php echo "Rp." . number_format($jmlretpo, 2, '.', ','); ?>+
										<hr>
									</td>
									<td align="right"><?php  ?></td>
									<td align="right"><?php  ?></td>
								...
								<tr class="body">
									<td colspan='7'>
										<div align="left">Pembelian Bersih</div>
									</td>
									<td align="right"><?php echo "Rp." . number_format($pblbersih, 2, '.', ','); ?>
										<hr>
									</td>
								...
								<tr class="body">
									<td colspan='7'>
										<div align="left">Barang Siap Jual</div>
									</td>
								...
								<tr class="body">
									<td colspan='7'>
										<div align="left">Persediaan Akhir</div>
									</td>
									<td align="right"><?php echo "Rp." . number_format($total1, 2, '.', ','); ?>
										<hr>
									</td>
									<td align="right"><?php echo "-"; ?></td>
									<td align="right"><?php  ?></td>
								...
								<tr class="body">
									<td colspan='9'>
										<div align="left">Harga Pokok Penjualan</div>
									</td>
									<td align="right"><?php echo "Rp." . number_format($hpp, 2, '.', ','); ?></td>
									<td align="right"><?php  ?></td>
								</tr>
						...
						<div class="table-responsive">
							<table class="table table-hover">
								<tr>
									...
									<th>
										<div align="center">Nomor Bukti</div>
									</th>
									<th>
								...
								?>
									<tr class="body">
										...
										<td>
											<div align="center"><?php echo $row_tran['tanggal']; ?></div>
										</td>
										<td>
											<div align="center"><?php echo $row_tran['kd_pjl']; ?></div>
										</td>
										<td>
											<div align="center"><?php echo number_format($row_tran['total'], 2, '.', ','); ?></div>
										</td>
									</tr>
								<?php
									$no++;
								...
								<tr class="footer">
									<td colspan="3">
										<div align="center"><strong>TOTAL PENJUALAN</strong></div>
									</td>
									<td>
										<div align="center"><strong><?php echo number_format($total['total'], 2, '.', ','); ?></strong></div>
									</td>
								</tr>
							</table>
								...
								<div class="panel panel-default">
									...
									<div class="panel-body">
										<fieldset class="tanggal">
											<form action="lpb" method="post" name="postform">
												Periode<span style='margin-left:10px'></span><?php
									...
									<div class="table-responsive">
										<table class="table table-hover">
											<tr>
												...
												<th>
													<div align="center">Nomor Faktur</div>
												</th>
												<th>
													<div align="center">Tanggal Faktur</div>
												</th>
												<th>
													<div align="center">Supplier</div>
												</th>
												<th>
													<div align="center">Total</div>
												</th>
											...
											?>
												<tr class="body">
													...
													<td>
														<div align="center"><?php echo $row_tran['kd_pmb']; ?></div>
													</td>
													<td>
														<div align="center"><?php echo $row_tran['nofaktur']; ?></div>
													</td>
													<td>
														<div align="center"><?php echo $row_tran['tgl_faktur']; ?></div>
													</td>
													<td>
														<div align="center"><?php echo $row_tran['nm_supplier']; ?></div>
													</td>
											...
											<tr class="footer">
												<td colspan="6">
													<div align="center"><strong>TOTAL PEMBELIAN</strong></div>
												</td>
														...
														<div class="table-responsive">
															<table class="table table-striped table-bordered table-hover" id="dataTables-example">
																...
																<tbody>
																	...
																	?>
																		<tr>
																			...
																			<td>
																				<div align="center"><?php echo $row_tran['0']; ?></div>
																			</td>
																			<td>
																				<div align="left"><?php echo $row_tran['1']; ?></div>
																			</td>
																			<td>
																				<div align="left"><?php echo $row_tran['2']; ?></div>
																			</td>
																			<td>
																				<div align="center"><?php echo $row_tran['3']; ?></div>
																			</td>
																			<td>
																				<div align="center"><?php echo $row_tran['4']; ?></div>
																			</td>
																...
																<tfoot>
																	<tr>
																		<td colspan="9">
																			<div align="center"><strong>TOTAL Persediaan</strong></div>
																		</td>
