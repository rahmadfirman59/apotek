								...
								<tbody>
									...
									while ($r = mysql_fetch_array($tampil)) {
										echo "<tr class='odd gradeX'>
												...
												<td>$r[alamat]</td>
												<td>$r[no_hp]</td>
												<td><a href=supplieredit.$r[id]><i class='fa fa-edit'></i></a> | 
												<a href=$aksi?module=supplier&act=hapus&id=$r[id] Onclick=\"return confirm('Apakah Anda yakin akan menghapus $r[nm_supplier]?')\">
						...
						<div class="row">
							<div class="col-lg-12">
								<div class="form-group">
									<label>Kode Supplier</label> <input type="text" id="id_supplier" class="form-control">
									<div id="pesan"> </div>
						...
						<div class="row">
							<div class="col-lg-12">
								<div class="form-group">
									...
									echo "
											<input type=hidden id='supplier_id' value='$r[id]' class='form-control'> 
											<label>Id Supplier </label>  
												<input type=text id='id_supplier' value='$r[id_supplier]' class='form-control'> 
												<span id='pesan'> </span>
											<label>Nama Supplier </label>  
												<input type=text id='nm_supplier' value='$r[nm_supplier]' class='form-control'>
											<label>Kota </label> 
											<input type=text id='kota'  value='$r[kota]' class='form-control'>
											<label>Alamat </label> 
												<span style='margin-left:10px'></span> 
												<textarea id='alamat' class='form-control'>$r[alamat]
												</textarea>
